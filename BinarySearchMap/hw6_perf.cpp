...
int main(int argc, char* argv[])
{
  ...
  cout << "# Column 7 = binsearch map contains" << endl;

  cout << "# Column 8 = array map find range" << endl;
  cout << "# Column 9 = binsearch map find range" << endl;

  cout << "# Column 10 = array map next key" << endl;
  cout << "# Column 11 = binsearch map next key" << endl;

  cout << "# Column 12 = array map sorted keys" << endl;
  cout << "# Column 13 = binsearch map sorted keys" << endl;
  ...
  for (int n = start; n <= stop; n += step) {
    ...
    //cout << "bwooga wooga akfnalkfjnk.zjsbn.kjg" << endl;/////////////////////////////
    // find next
    double c10 = timed_next_key(m1, med);
    //cout << "cwooga wooga akfnalkfjnk.zjsbn.kjg" << endl;/////////////////////////////
    cout << c10 << " ";
    double c11 = timed_next_key(m2, med);
    //cout << "dwooga wooga akfnalkfjnk.zjsbn.kjg" << endl;/////////////////////////////
    cout << c11 << " ";    
    // sort
