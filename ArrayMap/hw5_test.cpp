...
// FILE: hw5_test.cpp
// DATE: Fall 2021
// DESC: Basic unit tests of array and linked map for HW-5
//---------------------------------------------------------------------------
...
TEST(BasicArrayMapTests, NextKeyCheck)
{
  ArrayMap<char,int> m;
  m.insert('e', 50);
  m.insert('a', 10);
...
TEST(BasicArrayMapTests, PrevKeyCheck)
{
  ArrayMap<char,int> m;
  m.insert('f', 50);
  m.insert('b', 10);
...
TEST(BasicLinkedMapTests, NextKeyCheck)
{
  LinkedMap<char,int> m;
  m.insert('e', 50);
  m.insert('a', 10);
...
TEST(BasicLinkedMapTests, PrevKeyCheck)
{
  LinkedMap<char,int> m;
  m.insert('f', 50);
  m.insert('b', 10);
