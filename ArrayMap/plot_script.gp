...
# Plot the data
set title "ArrayMap vs LinkedMap Insert Performance";
plot  infile u 1:2 t "ArrayMap Insert" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:3 t "LinkedMap Insert" w linespoints lw 3 lc rgb RED pointtype 6;
...
# Plot the data
set title "ArrayMap vs LinkedMap Erase Performance";
plot  infile u 1:4 t "ArrayMap Erase" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:5 t "LinkedMap Erase" w linespoints lw 3 lc rgb RED pointtype 6;

# Save the graph
set output outfile3

# Plot the data
set title "ArrayMap vs LinkedMap Contains Performance";
plot  infile u 1:6 t "ArrayMap Contains" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:7 t "LinkedMap Contains" w linespoints lw 3 lc rgb RED pointtype 6;

# Save the graph
set output outfile4

# Plot the data
set title "ArrayMap vs LinkedMap Find Range Performance";
plot  infile u 1:8 t "ArrayMap Find Range" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:9 t "LinkedMap Find Range" w linespoints lw 3 lc rgb RED pointtype 6;

# Save the graph
set output outfile5

# Plot the data
set title "ArrayMap vs LinkedMap Next Key Performance";
plot  infile u 1:10 t "ArrayMap Next Key" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:11 t "LinkedMap Next Key" w linespoints lw 3 lc rgb RED pointtype 6;
...
# Plot the data
set title "ArrayMap vs LinkedMap Sorted Keys Performance";
plot  infile u 1:12 t "ArrayMap Sorted Keys" w linespoints lw 3 lc rgb BLUE pointtype 6, \
      infile u 1:13 t "LinkedMap Sorted Keys" w linespoints lw 3 lc rgb RED pointtype 6;
