...
int main(int argc, char* argv[])
{
  ...
  cout << "# Column 5 = array map erase" << endl;
  cout << "# Column 6 = binsearch map erase" << endl;
  cout << "# Column 7 = hash map erase" << endl;
  
  cout << "# Column 8 = array map contains" << endl;
  cout << "# Column 9 = binsearch map contains" << endl;
  cout << "# Column 10 = hash map contains" << endl;
  
  cout << "# Column 11 = array map find range" << endl;
  cout << "# Column 12 = binsearch map find range" << endl;
  cout << "# Column 13 = hash map find range" << endl;
  
  cout << "# Column 14 = array map next key" << endl;
  cout << "# Column 15 = binsearch map next key" << endl;
  cout << "# Column 16 = hash map next key" << endl;
  
  cout << "# Column 17 = array map sorted keys" << endl;
  cout << "# Column 18 = binsearch map sorted keys" << endl;
  cout << "# Column 19 = hash map sorted keys" << endl;

  cout << "# Column 20 = min chain length" << endl;
  cout << "# Column 21 = max chain length" << endl;  
  cout << "# Column 22 = avg chain length" << endl;  
  ...
  for (int n = start; n <= stop; n += step) {
    ...
    // find next
    double c14 = timed_next_key(m1, med);
    cout << c14 << " " << flush;
    double c15 = timed_next_key(m2, med);
    cout << c15 << " " << flush;    
    double c16 = timed_next_key(m3, med);
    cout << c16 << " " << flush;    
    
    // sort
    double c17 = timed_sorted_keys(m1);
    cout << c17 << " " << flush;
    double c18 = timed_sorted_keys(m2);
    cout << c18 << " " << flush;    
    double c19 = timed_sorted_keys(m3);
    cout << c19 << " " << flush;    

    // stats
    int c20 = m3.min_chain_length();
    cout << c20 << " " << flush;
    int c21 = m3.max_chain_length();
    cout << c21 << " " << flush;
    double c22 = m3.avg_chain_length();
    cout << c22 << " " << flush;    
