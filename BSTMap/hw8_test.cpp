...
// NAME: S. Bowers
// DATE: Spring 2022
// DESC: Basic unit tests for HW-8
//---------------------------------------------------------------------------
...
TEST(BasicBSTMapTests, InsertCheck)
{
  BSTMap<char,int> m;
  m.insert('a', 10);
  m.insert('b', 20);
...
TEST(BasicBSTMapTests, SimpleContainsCheck)
{
  BSTMap<char,int> m;
  m.insert('a', 10);
  m.insert('b', 20);
...
TEST(BasicBSTMapTests, MoreInvolvedContainsCheck)
{
  BSTMap<char,int> m;
  for (int i = 'z'; i >= 'a'; --i) 
    m.insert(i, (int)i);
...
TEST(BasicBSTMapTests, NextKeyCheck)
{
  BSTMap<char,int> m;
  m.insert('e', 50);
  m.insert('a', 10);
...
TEST(BasicBSTMapTests, PrevKeyCheck)
{
  BSTMap<char,int> m;
  m.insert('e', 50);
  m.insert('a', 10);
...
TEST(BasicBSTMapTests, HeightEmptyCheck)
{
  BSTMap<int,int> m;
  ASSERT_EQ(0, m.size());
...
TEST(BasicBSTMapTests, NormalHeightCheck)
{
  // create a map
  BSTMap<char,int> m;
  m.insert('e', 40);
...
TEST(BasicBSTMapTests, StatsLinkedListCheck)
{
  int n = 26;
  BSTMap<char,int> m;
  for (char i = 'a'; i <= 'z'; ++i)
    m.insert(i, (int)i);
  ASSERT_EQ(n, m.size());
  ASSERT_EQ(n, m.height());
}

TEST(BasicBSTMapTests, StatsLeftLeaningCheck)
{
  BSTMap<char,int> m;
  m.insert('h', 0);
  m.insert('d', 1);
