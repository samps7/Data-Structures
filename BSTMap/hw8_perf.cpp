...
int main(int argc, char* argv[])
{
  ...
  cout << "# Column 3 = binsearch map insert" << endl;
  cout << "# Column 4 = hash map insert" << endl;
  cout << "# Column 5 = bst map insert" << endl;
  
  cout << "# Column 6 = array map erase" << endl;
  cout << "# Column 7 = binsearch map erase" << endl;
  cout << "# Column 8 = hash map erase" << endl;
  cout << "# Column 9 = bst map erase" << endl;
  
  cout << "# Column 10 = array map contains" << endl;
  cout << "# Column 11 = binsearch map contains" << endl;
  cout << "# Column 12 = hash map contains" << endl;
  cout << "# Column 13 = bst map contains" << endl;
  
  cout << "# Column 14 = array map find range" << endl;
  cout << "# Column 15 = binsearch map find range" << endl;
  cout << "# Column 16 = hash map find range" << endl;
  cout << "# Column 17 = bst map find range" << endl;
  
  cout << "# Column 18 = array map next key" << endl;
  cout << "# Column 19 = binsearch map next key" << endl;
  cout << "# Column 20 = hash map next key" << endl;
  cout << "# Column 21 = bst map next key" << endl;
  
  cout << "# Column 22 = array map sorted keys" << endl;
  cout << "# Column 23 = binsearch map sorted keys" << endl;
  cout << "# Column 24 = hash map sorted keys" << endl;
  cout << "# Column 25 = bst map sorted keys" << endl;
  
  cout << "# Column 26 = bst map height shuffled" << endl;
  cout << "# Column 27 = log base 2 of input size" << endl;  
